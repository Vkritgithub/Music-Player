...
const audioPlayerElement = document.getElementById('audio-player'); // different variable

songs.forEach((songPath, index) => {
  const li = document.createElement('li');
  li.textContent = songNames[index];
  li.classList.add('playlist-item');
  li.addEventListener('click', () => {
    audioPlayerElement.src = songPath;
    audioPlayerElement.play();
    album_name.innerText = songNames[index]; // assuming 'album_name' is declared
  });
